...
class DataProcessorThread(QThread):
    ...
    def get_displaying_parameters(self, viewbox_length, sampling_rate, downsampling_period):
        ...
        # self.points_to_be_displayed = int(1e6)
        # data array
    ...
    def prepare_data_to_queue(self, data, i, n_read):
        ...
        # data_to_plot = [mean_value_apd, sd_value_apd, \
        #                 mean_value_monitor, sd_value_monitor, \
        ...
        #                 item_std_monitor_plus_data_curve, item_std_monitor_minus_data_curve]
        # # ----- Queue_data
        # queue_data.put(data_to_plot)
        return

    def make_connections(self, backend, frontend):
        backend.dataSignal.connect(self.prepare_data_to_queue)
...
class Frontend(QtGui.QFrame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.displayDataTimer.timeout.connect(self.displayTrace) 
